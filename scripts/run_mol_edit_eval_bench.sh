...
MODEL_DIR=${1:-/mnt/shared-storage-user/yangzhuo/main/projects/agentrl/AgentFly/verl/checkpoints/AgentRL/moledit-3b/}
BENCH_DIR=${2:-/mnt/shared-storage-user/yangzhuo/main/projects/agentrl/AgentFly/ChemCoTBench_benchmark/chemcotbench/mol_edit}
OUT_DIR=${3:-/mnt/shared-storage-user/yangzhuo/main/projects/agentrl/AgentFly/outputs/mol_edit_eval_bench_3b/}
MAX_NEW=${MAX_NEW_TOKENS:-1024}
TEMP=${TEMP:-0.7}
TOP_P=${TOP_P:-0.95}
