...
PRED_DIR="${2:-/mnt/shared-storage-user/yangzhuo/main/projects/agentrl/AgentFly/outputs/mol_edit_eval_bench_3b}"
OUT_DIR="${3:-/mnt/shared-storage-user/yangzhuo/main/projects/agentrl/AgentFly/outputs/chemcotbench_results_3b}"
