...
# Only download wordnet if it doesn't exist, use quiet mode to avoid SSL errors
try:
    ...
    try:
        ...
        # If download fails (e.g., network issues), continue without wordnet
        # METEOR score may not work, but other metrics will still function
        pass
